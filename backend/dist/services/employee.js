...
class EmployeeService {
    ...
    async getAllEmployees(limit = 100, offset = 0) {
        const client = await this.pool.connect();
        try {
    ...
    async getEmployeesByCompanyId(companyId, limit = 100, offset = 0) {
        const client = await this.pool.connect();
        try {
    ...
    async getActiveEmployeesCount(companyId) {
        const client = await this.pool.connect();
        try {
    ...
    async searchEmployees(query, limit = 50) {
        const client = await this.pool.connect();
        try {
            const sql = `
    ...
    async getEmployeesByDepartment(department, companyId, limit = 50) {
        const client = await this.pool.connect();
        try {
